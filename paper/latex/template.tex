...
\abstract{ O objetivo desse projeto é construir o jogo Street Fighter 2 utilizando um microprocessador MIPS no kit de desenvolvimento DE2-70, aplicando os conhecimentos adquiridos durante a disciplina. O processador escolhido foi o MIPS Pipeline, e foi utilizado o cartão sd para armazenar as sprites do jogo.
