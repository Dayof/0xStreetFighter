...
\abstract{ The objetcito of this project is to build the game Street Fighter 2 using microprocessor MIPS on development kit DE2-70, apllying the content learning during the course. 
